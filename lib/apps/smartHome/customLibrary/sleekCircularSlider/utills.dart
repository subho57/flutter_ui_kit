...
double calculateRawAngle({@required double startAngle, @required double angleRange, @required double selectedAngle, bool counterClockwise = false}) {
...
double calculateAngle({@required double startAngle, @required double angleRange, @required selectedAngle, @required defaultAngle, bool counterClockwise = false}) {
  if (selectedAngle == null) {
    return defaultAngle;
  }

  double calcAngle = calculateRawAngle(startAngle: startAngle, angleRange: angleRange, selectedAngle: selectedAngle, counterClockwise: counterClockwise);
...
bool isAngleWithinRange({@required double startAngle, @required double angleRange, @required touchAngle, @required previousAngle, bool counterClockwise = false}) {
  double calcAngle = calculateRawAngle(startAngle: startAngle, angleRange: angleRange, selectedAngle: touchAngle, counterClockwise: counterClockwise);
