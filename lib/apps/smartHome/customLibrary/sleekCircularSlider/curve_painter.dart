...
class _CurvePainter extends CustomPainter {
  ...
  _CurvePainter({this.appearance, this.angle = 30, this.startAngle, this.angleRange})
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final dynamicGradient = appearance.dynamicGradient != null ? appearance.dynamicGradient : false;
