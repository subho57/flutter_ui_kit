...
class _ModalBottomSheetLayout extends SingleChildLayoutDelegate {
  _ModalBottomSheetLayout(this.progress, this.topOffset);
...
class _ModalBottomSheet<T> extends StatefulWidget {
  const _ModalBottomSheet({Key key, this.route, this.topOffset}) : super(key: key);
          ...
          return Semantics(
            ...
            child: ClipRect(
              child: CustomSingleChildLayout(
                delegate: _ModalBottomSheetLayout(animationValue, widget.topOffset),
                child: BottomSheet(
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  _ModalBottomSheetRoute({this.builder, this.theme, this.barrierLabel, RouteSettings settings, this.topOffset}) : super(settings: settings);
  ...
  Widget buildPage(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation) {
    ...
    Widget bottomSheet = MediaQuery.removePadding(
      context: context,
      removeTop: true,
      child: _ModalBottomSheet<T>(route: this, topOffset: this.topOffset),
    );
...
Future<T> showModalBottomSheetCustom<T>({@required BuildContext context, @required WidgetBuilder builder, @required double topOffset}) {
  assert(context != null);
  assert(builder != null);
