...
import 'package:mighty_ui_kit/widgets/materialAppWidget/MTInformationDisplayWidget/MWChipScreen.dart';
...
List<AppModel> getAppsAndWidgets() {
  ...
  list.add(AppModel(title: 'Full App UI', description: '${getFullAppsList().length} Apps', subKit: getFullAppsList()));
...
List<AppModel> getFullAppsList() {
  ...
  list.add(AppModel(title: 'Finance', description: 'Premium Finance Mobile App UI Kit', widget: FASplashScreen(), isDarkModeSupported: true, themeType: ThemeTypeFullApp, tag: 'New'));
  list.add(AppModel(title: 'Food Delivery', description: 'The Best Shopping app for all your grocery.', widget: FDSplashScreen(), isDarkModeSupported: false, themeType: ThemeTypeFullApp, tag: 'New'));
...
List<AppModel> getDrawerWidget() {
  ...
  list.add(AppModel(title: 'Drawer 2', widget: MWDrawerScreen2(), isContainsScaffold: true));
  list.add(AppModel(title: 'Drawer 3', widget: MWDrawerScreen3(), isContainsScaffold: true));
