          ...
          children: [
            Container(
              ...
              child: CupertinoSlidingSegmentedControl(
                children: {
                  0: Container(padding: EdgeInsets.all(8), child: Text('Home', style: primaryTextStyle(color: _sliding == 0 ? null : grey))),
                  1: Container(padding: EdgeInsets.all(8), child: Text('Booking', style: primaryTextStyle(color: _sliding == 1 ? null : grey))),
                  2: Container(padding: EdgeInsets.all(8), child: Text('Setting', style: primaryTextStyle(color: _sliding == 2 ? null : grey))),
                },
                groupValue: _sliding,
