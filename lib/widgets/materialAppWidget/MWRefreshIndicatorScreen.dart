              ...
              child: Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(data.name, style: boldTextStyle(), maxLines: 1, overflow: TextOverflow.ellipsis),
                      4.height,
                      Text(data.address, style: secondaryTextStyle(), maxLines: 1, overflow: TextOverflow.ellipsis),
                    ],
                  ).expand(),
                ],
              ),
